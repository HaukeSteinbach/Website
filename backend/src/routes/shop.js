    ...
    downloads: product.demo
      ? [
          /* Englisch, weil diese Auskunft die Produktseite fuellt und die auf
             ...
             Datei. */
          /* Ohne das Wort "Demo": darueber steht schon, dass die Demo das
             vollstaendige Plug-in ist und nichts kostet. Es zweimal zu sagen
             laesst den Knopf kleiner wirken, als er ist. */
          { id: 'mac', label: 'Download macOS', url: '/download/chain-macos',
            da: config.chainDownloads.mac },
          { id: 'windows', label: 'Download Windows', url: '/download/chain-windows',
            da: config.chainDownloads.windows },
          { id: 'manual', label: 'Download Manual', url: '/download/chain-manual',
